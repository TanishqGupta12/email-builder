...
export function ReferralTemplatePicker({ onApply }: Props) {
  ...
  function onApplyTemplate(t: ReferralTemplate) {
    ...
    onApply({ subject, bodyPlain: t.body });
  }
      ...
      >
        <div>
          ...
          <p className="mt-0.5 text-xs text-slate-500">
            LinkedIn DM & email — freshers & experienced. Fill{" "}
            <span className="text-emerald-500/90">[placeholders]</span> in{" "}
            <strong className="text-slate-400">Dynamic fields</strong> below after inserting.
          </p>
        </div>
